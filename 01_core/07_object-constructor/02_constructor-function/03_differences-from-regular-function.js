...
console.log(teacher);       // 일반 함수로 서 호출된 Teacher는 반환문이 없기 때문에 undefined 으로 반환
...
// new 연산자 없이 일반 함수로 호출시, 함수 내부의 new.target은 undefined이다.
...
// new 연산자와 함께 호출 되었는지 확인후 적절한 값을 반환한다.
const obj = Object();
console.log(obj);       // new 연산자 없이 잘 동작하여 빈 객체를 반환한다.

// Strung, Number, Boolean의 경우 new 연산자 없이 호출하면 객체 값이 아닌
