...
/* 
    ...
    1. 모든 코드가 전역 변수를 참조하고 변경할 수 있는 "암묵적 결합"을 허용한다.
        ...
        상태가 변경될 수 있는 위험성이 높다.
    2. 전역 변수는 생명주기가 길다.
        메모리 리소스도 오래 소비하며, 상태 변경이 가능한 시간 밒 기회가 많다.
        더욱이 중복된 변수명ㅇㄹ 통해 의도치 않은 재할당이 일어날수있음
    3. 스코프체인 상에서 종점에 존재 하므로 전역 변수의 검색속도가 가장느리다.
    4. 네임스페이스가 오염된다.
        자바스크립트는 파일이 분리 되어 있어도 하나의 전역 스코프를 공유 하므로
        예상치 못한 결과를 가져올 수 있다.
